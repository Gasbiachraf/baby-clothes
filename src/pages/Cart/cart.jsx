    ...
    return (
        <section className='flex flex-col items-center'>
            <div className='lg:w-[90%]'>
                ...
                <div className={panier.length == 0 ? "hidden" : ""}>
                    <TableCart />
                </div>
                <div className={panier.length != 0 ? "hidden mb-10" : ""}>
                    <div class="h-[70vh] w-[100%] bg-gray-100 flex items-center">
                ...
                <div className="flex justify-between py-10">
                    <div className="flex  gap-4">
                        <form className='flex justify-center lg:w-[30vw]'>
                            <input className='outline-none border-2 rounded-xl lg:w-[100%] pl-4 text-xl lg:ml-8' placeholder='Coupon code' type="text" />
                        </form>
                        <button className='bg-blue-500 px-6 py-3 rounded-xl text-white text-xl'>Apply</button>
                    </div>
                    <div className="flex gap-4">
                        <button className='bg-[#EAEAEA] px-6 py-2 rounded-xl text-xl'>Continue Shopping</button>
                ...
                <div className='flex justify-end w-[100%] py-10 '>
                    <div className='border-2 flex flex-col gap-2 rounded-xl lg:w-[50%] p-4'>
