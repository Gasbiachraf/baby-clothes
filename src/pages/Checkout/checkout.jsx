    ...
    return (
        ...
        <section className='flex justify-center'>
            <div className='lg:w-[88%]'>
                ...
                <h1 className='text-4xl font-semibold pb-10'>Check out</h1>
                <div className='flex gap-20 pb-16'>
                    {/* left side */}
                    <div className="flex flex-col gap-10 lg:w-[55%] sm:w-[100%]">
                        <div className='w-[100%] flex flex-col gap-4 border rounded-3xl  px-4 py-6'>
                            ...
                            <form className='flex flex-col text-xl gap-4'>
                                ...
                                <div className='w-[100%]'>
                                    <label className='text-xl'>Order note (optional)*</label>
                        ...
                        <div className='w-[100%] flex flex-col  border rounded-3xl  px-4 py-6'>
                            ...
                            <form className='flex flex-col text-xl gap-2'>
                                ...
                                <div className='w-[100%] flex gap-4 pt-4'>
                                    <input checked className='w-[3%]' type="checkbox" />
                                    <label className='text-xl'>Use shipping address as billing address</label>
                                </div>
                                <div className='w-[100%] flex gap-4 pb-8'>
                                    <input className='w-[3%]' type="checkbox" />
                                    <label className='text-xl text-blue-500 font-bold'>PayPAL</label>
                                </div>
